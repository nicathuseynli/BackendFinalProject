...
namespace Backend_Final_Project.Areas.Admin.Controllers
{
    ...
    public class ShippingController : Controller
    {
        ...
        public async Task<IActionResult> Create(CreateShippingVM createShippingVM)
        {
            ...
            string filename = Guid.NewGuid().ToString() + "_" + createShippingVM.Photo.FileName;
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            string path = Path.Combine(_webHostEnvironment.WebRootPath, "images", shippings.Image);
        ...
        public async Task<IActionResult> Update(UpdateShippingVM updateshippingsVM)
        {
            ...
            if (updateshippingsVM.Photo != null)
            {
                ...
                string oldPath = Path.Combine(_webHostEnvironment.WebRootPath, "images", updateshippings.Image);
